...
export const DEFAULT_RADIO_LOCAL_CONFIG: RadioLocalConfig = {
  blocks: {
    ...
    summary: true,
    beep: true,
    // Дефолт включён (по решению владельца, 2026-09-23): каждая SSE-новость
    // автоматически встаёт в очередь озвучки. Защита от «нажал плей — прилетело
    // прямо много» — кулдаун 30 с после ▶ Эфир и лимит очереди 30 (ТЗ-47).
    // Юзер может выключить тумблером «Автоплей новых» в настройках эфира (ТЗ-49).
    autoRead: true,
  },
  threshold: 50,
  newsPace: 'normal',
