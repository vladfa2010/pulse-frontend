 ...
 *   6а. DemoFeedCarousel — демо-лента с графиками от демо-аккаунта (только гостям, перед общей лентой — ТЗ-59/60)
 *   7. GlobalNewsCarousel — общая лента без фильтра тегов (только авторизованным; с гостевой главной убрана — гостю демо-лента)
 ...
 *  14а. GlobalSummary isPublic — «Пульс рынка», ИИ-саммари всей ленты для гостей (только кэш, /api/public/summary-global; сразу под каруселью)
