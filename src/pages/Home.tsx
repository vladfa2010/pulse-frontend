 ...
 *  18. Hero «Ваши инструменты» — заголовок, закреплён внутри сцены ScrollStack (только гостям — ТЗ-78)
...
const DEMO_FEED_TEXT = 'Это демо-лента: ИИ прочитал сотни новостей и выбрал интересные вам, убрал дубли и дал оценку. По каждой новости построил график — сразу видно реакцию на событие'
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ==================== SCROLLSTACK «ИНСТРУМЕНТЫ» (гостям, ТЗ-77/78/80) ==================== */}
      {/* Стопка из 5 карточек-инструментов. Заголовок «Ваши инструменты» закреплён
          внутри sticky-сцены через prop header (бывшая hero-секция удалена — ТЗ-78).
          Ранвей = компактная сцена (~56vh, ТЗ-80) + 4×100vh на перебор карточек. */}
