...
// Локальный патч PULSE (ТЗ-81): типы three (@types/three) намеренно не
...
// @ts-ignore -- three без типов, см. комментарий выше
...
const HoleScene: React.FC<HoleSceneProps> = ({
  ...
  // Локальный патч PULSE (ТЗ-81): типы three (@types/three) не подключаем —
  // они ломают вывод типов lucide-react в админке. Модуль шимится как any.
  // @ts-ignore
