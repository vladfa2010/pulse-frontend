...
export const ScrollStack = ({
  ...
  // ТЗ-80: сцена = navbar-отступ + заголовок + зазор 28vh + карточка + зона рейла.
  ...
  const stageH =
    ...
    ` + (clamp(32px, 5.33vw, 64px) * 1.05) + 28vh + ${cardVh}vh + 64px)`;
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            marginTop:
              'calc(4rem + env(safe-area-inset-top, 0px) + 20px' +
              ' + (clamp(32px, 5.33vw, 64px) * 1.05) + 28vh)', // ТЗ-80: заголовок + зазор
          }}
        >
