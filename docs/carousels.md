...
- **Трек**: нативный горизонтальный скролл (`overflow-x-auto`, скроллбар скрыт, `-webkit-overflow-scrolling: touch`), карточки через `gap-3`, паддинги `px-6`, контент в `max-w-[1200px]`. Трек несёт `.scroll-container` с `overscroll-behavior-x: contain` (ТЗ-112; ось Y не ограничивать — вертикальный свайп с карусели должен скроллить страницу).
